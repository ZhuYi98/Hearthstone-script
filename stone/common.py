...
class runStatus(object):
    ...
    def bRunning(self):return self._bRunning
    def setRunning(self,result):self._bRunning=result
    def getRunTime(self):return runStatus._runTime
    def setRunTime(self):runStatus._runTime=int(time.time())
